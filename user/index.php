          ...
          <div class="glass-card balance-card dash-reveal h-100" style="animation-delay: 0s;">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
              ...
              <div class="d-flex gap-2 flex-wrap">
                ...
                <button class="btn btn-veri-primary" id="provideHelp"><a href="phGh" style="color:white;"><i class="bi bi-plus-circle me-2"></i>Provide Help</a></button>
...
>
    ...
    <span id="topuptext">Top UP</span>
                ...
                <button id="claimBinaryBtn" class="btn btn-veri-outline" onclick="calculateStakingBalance()"><i class="bi bi-arrow-down-circle me-2"></i><span id="claimText">Claim Level Binary</span></button>
                <span class="recommitContainer"></span>
                <span id="recommitTimer12hour"></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row g-3 mb-3">
        <div class="col-lg-12">
          <div class="glass-card contract-info-card dash-reveal h-100" style="animation-delay: 0.1s;">
            ...
            <div class="d-flex align-items-start pt-2 gap-3">
              <div class="contract-info-card__icon"><i class="bi bi-file-earmark-lock2"></i></div>
              <div>
                <h6 class="mb-1">DEX Pair Address</h6>
              </div>
            </div>
            <div class="contract-addr-box">
              <code class="pair_addr" >..</code>
              <button class="btn btn-veri-outline btn-sm" onclick="copyToClipboard(document.querySelector('.pair_addr').dataset.address,'Pair address copied')"><i class="bi bi-copy me-1"></i>Copy</button>
              <a href="#" rel="noopener noreferrer" class="btn btn-veri-outline btn-sm dextools_link"><i class="bi bi-box-arrow-up-right me-1"></i>DexTools</a>
            </div>
            <div class="d-flex align-items-start pt-3 gap-3">
              <div class="contract-info-card__icon"><i class="bi bi-file-earmark-lock2"></i></div>
              <div>
                <h6 class="mb-1">T20 Token</h6>
              </div>
            </div>
            <div class="contract-addr-box">
              <code class="token_addr" >..</code>
              <button class="btn btn-veri-outline btn-sm" onclick="copyToClipboard(document.querySelector('.token_addr').dataset.address,'T20 address copied')"><i class="bi bi-copy me-1"></i>Copy</button>
              <a href="#" class="btn btn-veri-outline btn-sm token_scan"><i class="bi bi-box-arrow-up-right me-1"></i>BscScan</a>
            </div>
      ...
      <div class="glass-card p-3 dash-reveal mb-4" style="animation-delay: 0.2s;">
        ...
        <div class="snapshot-strip">
          <!--<div class="snapshot-chip">-->
          <!--  <div class="snapshot-chip__label">Total Left Business</div>-->
          <!--  <div class="snapshot-chip__value leftBusiness">—</div>-->
          <!--</div>-->
          <!--<div class="snapshot-chip">-->
          <!--  <div class="snapshot-chip__label">Total Right Business</div>-->
          <!--  <div class="snapshot-chip__value rightBusiness">—</div>-->
          <!--</div>-->
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Left Live Cycle Booster</div>
            <div class="snapshot-chip__value leftBoosterBusiness">—</div>
          </div>
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Right Live Cycle  Booster</div>
            <div class="snapshot-chip__value rightBoosterBusiness">—</div>
          </div>
          <!-- <div class="snapshot-chip">
            <div class="snapshot-chip__label">Left Live Cycle Level Business</div>
            <div class="snapshot-chip__value leftlevelbusiness">--</div>
          </div>
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Right Live Cycle Level Business</div>
            <div class="snapshot-chip__value rightlevelbusiness">--</div>
          </div> -->
          <!-- <div class="snapshot-chip">
            <div class="snapshot-chip__label">Left Live Cycle Booster Recommit Business</div>
            <div class="snapshot-chip__value leftboosterreocommitbusiness">--</div>
          </div>
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Right Live Cycle Booster Recommit Business</div>
            <div class="snapshot-chip__value rightboosterreocommitbusiness">--</div>
          </div> -->
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Total Level Income</div>
            <div class="snapshot-chip__value totalLevelIncome">--</div>
          </div>
          <div class="snapshot-chip">
            <div class="snapshot-chip__label">Total Booster Income</div>
